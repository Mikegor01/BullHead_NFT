...
import showcase from '../images/preview.png'
import '../App.css'
			...
			<main>
				<section id='welcome' className='welcome'>
					...
					<Row className='header my-3 p-3 mb-0 pb-0'>
						...
						<Col className='flex social-icons'>
							<a
								href="https://twitter.com/mikegor1068"
								target='_blank'
					...
					<Row className='flex m-3'>
						<Col md={5} lg={4} xl={5} xxl={4} className='text-center'>
							<img
								src={`https://gateway.pinata.cloud/ipfs/QmYUDKsoj8mdsCDSqPMyspGe2zJ6bfnjT7jiaBSKrnBE14/${counter}.png`}
								alt="BullHead"
								className='showcase'
							/>
						</Col>
						<Col md={5} lg={4} xl={5} xxl={4}>
							...
							<p className='text'>
								By hiring Exorna Park Capital, you'll generate NFT images, upload to IPFS, create your NFT contract, and use OpenSea!
							</p>
				...
				<section id='about' className='about'>
					...
					<Row className='flex m-3'>
						...
						<Col md={5} lg={4} xl={5} xxl={4} className='text-center'>
							<img src={showcase} alt="Multiple moody BullHeads" className='showcase' />
						</Col>
						<Col md={5} lg={4} xl={5} xxl={4}>
							{isError ? (
								<p>{message}</p>
								...
								<div>
									...
									<ul>
										<li>100 generated moody bull images using an art generator</li>
										<li>Almost free minting on Rinkeby testnet</li>
